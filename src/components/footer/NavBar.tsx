    ...
    return (
        <nav className="fixed bg-white z-50 w-full lg:pb-0 pb-[65px] lg:border-none border-b border-b-sky-500">
            ...
            <section className="flex items-center w-full max-w-[1500px] mx-auto px-5 lg:px-10">
                ...
                {/* flex-shrink-0 keeps this the same width as the left block conceptually;
                    the logo left-edge and avatar right-edge will now be symmetrically inset
                    by the same px-5 / px-10 padding on the parent. */}
